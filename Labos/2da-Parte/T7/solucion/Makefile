...
OBJ=$(KERNEL_OBJ) gdt.o idt.o isr.o pic.o keyboard_input.o mmu.o screen.o tss.o sched.o task.o
...
CFLAGS=-Wall -Wextra -pedantic -std=c99 -Werror -Og -ggdb \
  -m32 -ffreestanding -fno-pie -fno-zero-initialized-in-bss -fno-stack-protector -Wno-unused-function -Wno-unused-parameter -Wno-return-type
