...
void screen_draw_layout(void) {
  ...
  screen_draw_box(0, 0, 50, 80, 0x00, C_BG_BLACK);
  
  print("Trabajo de Orga 2 - Furfi Kernel - GRUPO 9", 0, 0, C_FG_LIGHT_GREEN | C_BG_BLACK);    
  print("Victor :v", 0, 1, C_FG_LIGHT_GREEN | C_BG_BLACK);    
  print("Joaquin", 0, 2, C_FG_LIGHT_GREEN | C_BG_BLACK);    
  print("Marcos :)", 0, 3, C_FG_LIGHT_GREEN | C_BG_BLACK);
}